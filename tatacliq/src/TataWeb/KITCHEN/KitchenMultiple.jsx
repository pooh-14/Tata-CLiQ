// https://assets.tatacliq.com/medias/sys_master/images/47506122932254.jpg
import "./../MENS/Mensmultiple.css";
import myData from '../../data/kitchen.json'

function KitchenMultiple() {
  return(
    <div id="menz">
      <div id="one">
        <p>Furnishing</p>
...
export default KitchenMultiple;
